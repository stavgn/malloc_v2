...
// 	size_t size;
//     bool free;
//     MallocMetadata3* next_l
//     MallocMetadata3* prev_l
//     MallocMetadata3* next_s;
//     MallocMetadata3* prev_l;
// } Metadata3;
...
#define DO_MALLOC(x)                                                                              \
	...
	{                                                                                             \
		if (!(x))                                                                                 \
		{                                                                                         \
			std::cerr << "Failed to allocate at line: " << __LINE__ << ". command: " << std::endl \
					  << #x << std::endl;                                                         \
			exit(1);                                                                              \
		}                                                                                         \
	} while (0)
...
void printDebugInfo()
{
	std::cout << "Info For Debuging:" << std::endl
			  << "Your Metadata size is: " << size_of_metadata << std::endl;
